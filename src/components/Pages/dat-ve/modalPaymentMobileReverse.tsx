...
const ModalPaymentMobileReverse = (props: IModalPaymentMobileProps) => {
  const {
    BOOKING,
    PAYMENT,
    toggleModalPayment,
  ...
  const FAKE_DATAS = {
    ...
    tranferContent: {
      id: 4,
      value: `QBCODE ${payloadTicket?.code} ${payloadTicketReverse?.code}`,
    },
  };
          ...
          <div className='flex items-center justify-center gap-3 mt-5'>
            <Image
              ...
              src={
                ...
                }-qr_only.png?amount=${totalPrices || 0}&addInfo=${
                  'QBCODE ' +
                  payloadTicket?.code +
                  ' ' +
                  payloadTicketReverse?.code
...
export default ModalPaymentMobileReverse;
