...
interface IFirstStepProps {
  ...
  handleUpdateBookingSeat: (
    arg: string[],
    arg2: IReservationValidateSeatsData,
  ) => void;
  changeNextStep: () => void;
  seats: string[];
  tripId?: number;
  ...
  return (
    <div className='pb-28 relative'>
      ...
      <div className='py-3 px-2 mx-4 bg-white rounded-lg border border-neutral-grey-000'>
        {decks && Object.keys(decks)?.length === 1 && (
          <div
            className={
              lastRowSeats > 3
                ? 'flex flex-col gap-2'
        ...
        {decks && Object.keys(decks)?.length === 2 && (
          <div
            className={
              lastRowSeats > 3
                ? 'flex flex-col gap-2'
        ...
        <div className='mt-5 flex flex-col gap-3'>
          ...
          <div className='bg-[#EDF8FF] py-2 px-3  rounded'>
