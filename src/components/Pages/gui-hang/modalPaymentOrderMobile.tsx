...
const ModalPaymentOrderMobile = (props: IModalPaymentMobileProps) => {
  const {
    BOOKING,
    PAYMENT,
    code,
  ...
  const [selectedBank] = useState<IBankData | null>({
    id: 21,
          ...
          <div className="flex items-center justify-center gap-3 mt-5">
            <Image
              ...
              src={
                ...
                }-${`00025263688`}-qr_only.png?amount=${
                  totalPayment || 0
                }&addInfo=${code}&accountName=${`NGUYEN THI NGOC`}` ||
...
export default ModalPaymentOrderMobile;
