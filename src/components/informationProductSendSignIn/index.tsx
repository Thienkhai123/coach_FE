...
interface IInformationProductSendSignInProps {
...
const InformationProductSendSignIn = (
  props: IInformationProductSendSignInProps,
) => {
  const {
    CREATEORDER,
    informationPerson,
...
export default InformationProductSendSignIn;
