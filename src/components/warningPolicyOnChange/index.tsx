...
interface IWarningPolicyOnChangeProps {
  BOOKING: IBookingTranslate;
}

const WarningPolicyOnChange = (props: IWarningPolicyOnChangeProps) => {
  const { BOOKING } = props;
  return (
      ...
      <div className='mt-2'>
        ...
        <div className='mt-1'>
          <ul className='list-disc lg:pl-0 pl-5 lg:list-inside'>
            {BOOKING.policyOnChangeList.map((note, ind) => {
              return (
...
export default WarningPolicyOnChange;
